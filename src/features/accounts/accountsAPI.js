...
export const getAccounts = async () => {
    ...
    try {
        const response = await axiosInstance.get('accounts/getData.php');
...
export const addAccount = async (data) => {
    ...
    try {
        const response = await axiosInstance.post('/accounts/createData.php', {
            data:data,
...
export const editAccount = async (id, data) => {
    try {
        const response = await axiosInstance.put('/accounts/updateData.php', {
            data:data,
            id:id
        });
        console.log(response.data);
...
export const deleteAccount = async (id) => {
    ...
    try {
        const response = await axiosInstance.delete(`/accounts/deleteData.php?id=${id}`);
    return response
    } catch (error) {
        console.error('Error:', error);
    }
